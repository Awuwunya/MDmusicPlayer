; =============================================================================================
; ---------------------------------------------------------------------------------------------
; Example SMPS2ASM macro file for 68k type 1b; Mean to be derived from, when
...
; FD is an unknown flag todo: Check out what it does
...
; FF01wwxxyyzz - Enable SSG-EG (SSG_EG - SEG_FULLATK)
sSSGEG		macro op1,op2,op3,op4
	dc.b $FF,$01,\op1,\op3,\op2,\op4
    endm
