SkySanctuary_Header:
	...
	sHeaderPSG	SkySanctuary_PSG1, $F4, $05, ModEnv_00, VolEnv_00
	sHeaderPSG	SkySanctuary_PSG2, $F4, $05, ModEnv_00, VolEnv_00
	sHeaderPSG	SkySanctuary_PSG3, $00, $02, ModEnv_00, VolEnv_00
...
SkySanctuary_Loop8:
	...
	sLoop		$01, $02, SkySanctuary_Loop8
...
SkySanctuary_Loop6:
	...
	dc.b nA1
	sLoop		$00, $02, SkySanctuary_Loop6
...
SkySanctuary_Loop12:
	...
	dc.b nE5, $0C
	sLoop		$00, $03, SkySanctuary_Loop12
	dc.b nC5, $12, nB4
	saVolFM		$FF
	dc.b nG4, $0C, nRst
	saVolFM		$01
...
SkySanctuary_Loop13:
	...
	sLoop		$00, $02, SkySanctuary_Loop13
...
SkySanctuary_Loop14:
	...
	sLoop		$00, $02, SkySanctuary_Loop14
	dc.b nRst, $0C, nRst, nA4, nRst, nRst, nC5, nRst
	dc.b nRst, nF4, nRst, nRst, nA4, $24, nA4, $18
	dc.b nRst, $24, nAb4, $0C, nC5, nBb4, nAb4, nEb5
	dc.b $18, nC5, $0C, nD5, nEb5, $18, nD5, $0C
...
SkySanctuary_Jump6:
	...
	sLoop		$00, $0E, SkySanctuary_Loop15
	dc.b nRst, $0C, nB3, nRst, $18

SkySanctuary_Loop17:
	sCall		SkySanctuary_Call2
	sLoop		$00, $08, SkySanctuary_Loop17
	saTranspose	$07
	sCall		SkySanctuary_Call2
	saTranspose	$01
	sCall		SkySanctuary_Call2
...
SkySanctuary_Loop18:
	sCall		SkySanctuary_Call2
	sLoop		$00, $04, SkySanctuary_Loop18
	sJump		SkySanctuary_Jump6
	; Unused
	dc.b $F2
...
SkySanctuary_Loop16:
	...
	dc.b nC4
	sLoop		$01, $02, SkySanctuary_Loop16
	sRet	
...
SkySanctuary_Loop1:
	...
	sLoop		$00, $08, SkySanctuary_Loop1
	dc.b nRst, $01
