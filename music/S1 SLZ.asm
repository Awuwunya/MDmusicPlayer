StarLight_Header:
	sHeaderInit
	sHeaderPatch	StarLight_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$02, $06
	...
	sHeaderPSG	StarLight_PSG1, $C4, $06, ModEnv_00, VolEnv_05
	sHeaderPSG	StarLight_PSG2, $C4, $06, ModEnv_00, VolEnv_05
	sHeaderPSG	StarLight_PSG3, $00, $04, ModEnv_00, VolEnv_04
...
StarLight_Patches:
	...
	spAmpMod	$00, $00, $00, $00
	spDecayRt	$04, $04, $09, $03
	spSustainRt	$03, $03, $01, $00
	...
	spAmpMod	$00, $00, $00, $00
	spDecayRt	$02, $04, $07, $07
	spSustainRt	$03, $03, $09, $09
